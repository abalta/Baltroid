...
@Composable
fun AcademyScreen(onAction: OnAction) {
    LazyColumn(modifier = Modifier.fillMaxSize()) {
        ...
        item {
            Column(Modifier.fillMaxWidth(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
                MediumTitleText("Zeynep Begüm Kocaçal",
                    Modifier
                        .padding(start = 24.dp, top = 16.dp, end = 24.dp),
                )
                MediumText(text = "3 Eğitim", color = Color.Black.copy(0.5f), modifier = Modifier.padding(start = 24.dp, top = 16.dp, end = 24.dp))
                ReadMoreClickableText(text = "Eğitimin bu 1.bölümünde, Satışın ne olduğu hakkında bilgiler paylaşılıyor. Amaç, Satış mesleğini anlamak, hangi yetenek ve becerilere sahip olmamız ve geliştirmemiz gerektiği konusunda bilgi sahip olmaktır. Diğer bölümlerde ise bu yetenek ve becerilere tek tek yer veriliyor.", Modifier.padding(start = 24.dp, top = 16.dp, end = 24.dp))
            }
        }
        item {
            FilterHeadText(text = "Eğitmenler", Modifier.fillMaxWidth().padding(start = 24.dp, top = 22.dp, end = 24.dp), showIcon = false)
        }
        items(1) {
            MekikCardDouble(captionTop = "CCIM Institute", title = "Zeynep Begüm Kocaçal", captionBottom = "0 Eğitim"){

            }
        }
        item {
            FilterHeadText(text = "Eğitimler", Modifier.fillMaxWidth().padding(start = 24.dp, top = 22.dp, end = 24.dp), showIcon = false)
        }
        items(1) {
