...
sealed class HitReadsScreens(val route: String) {
    ...
    object CommentsScreen : HitReadsScreens("all_comments")
    object AvatarsScreen : HitReadsScreens("avatars")
    object NotificationsScreen : HitReadsScreens("notifications")
}
